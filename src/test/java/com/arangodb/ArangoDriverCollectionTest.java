...
public class ArangoDriverCollectionTest extends BaseTest {
	...
	public void test_getCollection_01() throws ArangoException {
		...
		// 名前で取得
		final CollectionEntity entity = driver.getCollection(collectionName);
		assertThat(entity.getId(), is(collectionId));
		assertThat(entity.getName(), is(collectionName));

		// Type確認
		assertThat(entity.getType(), is(CollectionType.DOCUMENT));
